namespace MyWebsite.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyWebsite.Models.API.ApiDbContext>
    {

        public readonly IApiDbContext _context;
        public readonly IProductAPIService _service;

        public Configuration():this(new ApiDbContext(), new DefaultProductService())
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "MyWebsite.Models.API.ApiDbContext";
        }
